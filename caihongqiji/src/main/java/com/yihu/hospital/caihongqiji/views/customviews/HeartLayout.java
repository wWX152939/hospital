...
import com.yihu.hospital.caihongqiji.utils.AbstractPathAnimator;
import com.yihu.hospital.caihongqiji.utils.PathAnimator;
...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        LayoutInflater.from(context).inflate(com.yihu.hospital.caihongqiji.R.layout.ly_periscope, this);
        bitmap = BitmapFactory.decodeResource(getResources(), com.yihu.hospital.caihongqiji.R.drawable.icon_like_png);
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, com.yihu.hospital.caihongqiji.R.styleable.HeartLayout, defStyleAttr, 0);
    ...
    private static int[] drawableIds = new int[]{com.yihu.hospital.caihongqiji.R.drawable.heart0, com.yihu.hospital.caihongqiji.R.drawable.heart1, com.yihu.hospital.caihongqiji.R.drawable.heart2, com.yihu.hospital.caihongqiji.R.drawable.heart3, com.yihu.hospital.caihongqiji.R.drawable.heart4, com.yihu.hospital.caihongqiji.R.drawable.heart5, com.yihu.hospital.caihongqiji.R.drawable.heart6, com.yihu.hospital.caihongqiji.R.drawable.heart7, com.yihu.hospital.caihongqiji.R.drawable.heart8,};
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.yihu.hospital.caihongqiji.R.id.img) {
