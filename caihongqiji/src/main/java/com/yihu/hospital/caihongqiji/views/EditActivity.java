...
public class EditActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.yihu.hospital.caihongqiji.R.layout.activity_edit);
        getIntent().getStringExtra("title");
        input = (EditText) findViewById(com.yihu.hospital.caihongqiji.R.id.editContent);
        ...
        TemplateTitle title = (TemplateTitle) findViewById(com.yihu.hospital.caihongqiji.R.id.ttHead);
