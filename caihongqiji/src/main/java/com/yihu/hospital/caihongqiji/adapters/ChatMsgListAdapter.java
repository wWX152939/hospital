...
public class ChatMsgListAdapter extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    private int calcNameColor(String strName) {
        ...
        switch (idx & 0x7) {
            case 1:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName1);
            case 2:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName2);
            case 3:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName3);
            case 4:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName4);
            case 5:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName5);
            case 6:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName6);
            case 7:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName7);
            case 0:
            default:
                return context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorSendName);
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(com.yihu.hospital.caihongqiji.R.layout.item_chatmsg, null);
            holder.textItem = (LinearLayout) convertView.findViewById(com.yihu.hospital.caihongqiji.R.id.text_item);
            holder.sendContext = (CustomTextView) convertView.findViewById(com.yihu.hospital.caihongqiji.R.id.sendcontext);
            convertView.setTag(com.yihu.hospital.caihongqiji.R.id.tag_first, holder);
        } else {
            holder = (ViewHolder) convertView.getTag(com.yihu.hospital.caihongqiji.R.id.tag_first);
        }
        ...
        if (item.getType() != Constants.TEXT_TYPE) {
            ...
            holder.textItem.setBackgroundResource(com.yihu.hospital.caihongqiji.R.drawable.img_chat_black);
            holder.sendContext.setTextColor(context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorTextWhite));
        } else {
            // 根据名称计算颜色
            holder.textItem.setBackgroundResource(com.yihu.hospital.caihongqiji.R.drawable.img_chat_white);
    ...
    protected void setTextColor(CustomTextView sendContext) {
        sendContext.setTextColor(context.getResources().getColor(com.yihu.hospital.caihongqiji.R.color.colorTextBlack));
    }
    ...
    private void stopViewAnimator(View itemView) {
        AnimatorSet aniSet = (AnimatorSet) itemView.getTag(com.yihu.hospital.caihongqiji.R.id.tag_second);
        if (null != aniSet) {
            aniSet.cancel();
    ...
    private void playViewAnimator(View itemView, float startAlpha, long duringTime) {
        ...
        itemView.setTag(com.yihu.hospital.caihongqiji.R.id.tag_second, aniSet);
    }
