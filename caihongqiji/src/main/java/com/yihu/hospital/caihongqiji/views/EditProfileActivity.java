...
import com.yihu.hospital.caihongqiji.presenters.UploadHelper;
import com.yihu.hospital.caihongqiji.presenters.viewinface.ProfileView;
import com.yihu.hospital.caihongqiji.presenters.viewinface.UploadView;
...
public class EditProfileActivity extends BaseActivity implements View.OnClickListener, ProfileView, UploadView{
    ...
    private void updateView(){
        ...
        if (TextUtils.isEmpty(MySelfInfo.getInstance().getAvatar())){
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), com.yihu.hospital.caihongqiji.R.drawable.default_avatar);
    ...
    private void initView(){
        ttEdit = (TemplateTitle) findViewById(com.yihu.hospital.caihongqiji.R.id.tt_edit);
        ivIcon = (ImageView) findViewById(com.yihu.hospital.caihongqiji.R.id.iv_ep_icon);
        lcvNickName = (LineControllerView) findViewById(com.yihu.hospital.caihongqiji.R.id.lcv_ep_nickname);
        lcvSign = (LineControllerView) findViewById(com.yihu.hospital.caihongqiji.R.id.lcv_ep_sign);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.yihu.hospital.caihongqiji.R.layout.activity_edit_profile);
    ...
    private void getPicFrom(int type) {
        if (!bPermission){
            Toast.makeText(this, getString(com.yihu.hospital.caihongqiji.R.string.tip_no_permission), Toast.LENGTH_SHORT).show();
            return;
        }
        switch (type) {
    ...
    private void showPhotoDialog() {
        final Dialog pickDialog = new Dialog(this, com.yihu.hospital.caihongqiji.R.style.floag_dialog);
        pickDialog.setContentView(com.yihu.hospital.caihongqiji.R.layout.pic_choose);
        ...
        TextView camera = (TextView) pickDialog.findViewById(com.yihu.hospital.caihongqiji.R.id.chos_camera);
        TextView picLib = (TextView) pickDialog.findViewById(com.yihu.hospital.caihongqiji.R.id.pic_lib);
        TextView cancel = (TextView) pickDialog.findViewById(com.yihu.hospital.caihongqiji.R.id.btn_cancel);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.yihu.hospital.caihongqiji.R.id.rl_ep_icon) {
            showPhotoDialog();

        } else if (i == com.yihu.hospital.caihongqiji.R.id.lcv_ep_nickname) {
            EditActivity.navToEdit(this, getString(com.yihu.hospital.caihongqiji.R.string.profile_nickname), MySelfInfo.getInstance().getNickName(), REQ_EDIT_NICKNAME);

        } else if (i == com.yihu.hospital.caihongqiji.R.id.lcv_ep_sign) {
            EditActivity.navToEdit(this, getString(com.yihu.hospital.caihongqiji.R.string.profile_sign), MySelfInfo.getInstance().getSign(), REQ_EDIT_SIGN);
